...
void APP_TCPIP_MANAGEMENT_Initialize ( void )
{
    ...
    app_tcpip_managementData.state = APP_TCPIP_MANAGEMENT_STATE_INIT;
...
void APP_TCPIP_MANAGEMENT_Tasks ( void )
{
    ...
    switch ( app_tcpip_managementData.state )
    {
        ...
        case APP_TCPIP_MANAGEMENT_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                app_tcpip_managementData.state = APP_TCPIP_MANAGEMENT_STATE_SERVICE_TASKS;
            }
            break;
        }

        case APP_TCPIP_MANAGEMENT_STATE_SERVICE_TASKS:
        {
