/*******************************************************************************
  ...
  Description:
    ...
    "APP_G3_MANAGEMENT_Initialize" and "APP_G3_MANAGEMENT_Tasks" prototypes) and some of them are only used
    internally by the application (such as the "APP_G3_MANAGEMENT_STATES" definition).  Both
...
typedef enum
{
    ...
    APP_G3_MANAGEMENT_STATE_INIT=0,
    APP_G3_MANAGEMENT_STATE_SERVICE_TASKS,
