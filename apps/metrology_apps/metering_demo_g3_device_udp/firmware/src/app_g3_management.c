...
void APP_G3_MANAGEMENT_Initialize ( void )
{
    ...
    app_g3_managementData.state = APP_G3_MANAGEMENT_STATE_INIT;
...
void APP_G3_MANAGEMENT_Tasks ( void )
{
    ...
    switch ( app_g3_managementData.state )
    {
        ...
        case APP_G3_MANAGEMENT_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                app_g3_managementData.state = APP_G3_MANAGEMENT_STATE_SERVICE_TASKS;
            }
            break;
        }

        case APP_G3_MANAGEMENT_STATE_SERVICE_TASKS:
        {
