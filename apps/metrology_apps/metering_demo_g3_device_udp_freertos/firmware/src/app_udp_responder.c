...
void APP_UDP_RESPONDER_Initialize ( void )
{
    ...
    app_udp_responderData.state = APP_UDP_RESPONDER_STATE_INIT;
...
void APP_UDP_RESPONDER_Tasks ( void )
{
    ...
    switch ( app_udp_responderData.state )
    {
        ...
        case APP_UDP_RESPONDER_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                app_udp_responderData.state = APP_UDP_RESPONDER_STATE_SERVICE_TASKS;
            }
            break;
        }

        case APP_UDP_RESPONDER_STATE_SERVICE_TASKS:
        {
