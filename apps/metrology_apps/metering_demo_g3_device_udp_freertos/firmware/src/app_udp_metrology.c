...
void APP_UDP_METROLOGY_Initialize ( void )
{
    ...
    app_udp_metrologyData.state = APP_UDP_METROLOGY_STATE_INIT;
...
void APP_UDP_METROLOGY_Tasks ( void )
{
    ...
    switch ( app_udp_metrologyData.state )
    {
        ...
        case APP_UDP_METROLOGY_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                app_udp_metrologyData.state = APP_UDP_METROLOGY_STATE_SERVICE_TASKS;
            }
            break;
        }

        case APP_UDP_METROLOGY_STATE_SERVICE_TASKS:
        {
