...
#define APP_UDP_IPV6_LINK_LOCAL_ADDRESS_G3 "FE80:0:0:0:781D:FF:FE00:0001"

/* Network prefix for G3 unique local address (ULA) */
#define APP_UDP_IPV6_NETWORK_PREFIX_G3     "FD00:0:2:781D:0:0:0:0"
#define APP_UDP_IPV6_NETWORK_PREFIX_G3_LEN 64

/* IPv6 Multicast groups required in Conformance Test */
#define APP_UDP_IPV6_MULTICAST_0_CONFORMANCE "ff02:0:0:0:0:0:0:1"
#define APP_UDP_IPV6_MULTICAST_1_CONFORMANCE "ff12:30:1122:3344:5566:0:123:4567"

/* Port number for conformance UDP responder */
#define APP_UDP_SOCKET_PORT_CONFORMANCE 0xF0BF
...
typedef enum
{
    ...
    APP_UDP_RESPONDER_STATE_WAIT_NETWORK_JOIN,

    /* Opening UDP server */
    APP_UDP_RESPONDER_STATE_OPENING_SERVER,

    /* Waiting for connection ready */
    APP_UDP_RESPONDER_STATE_WAIT_FOR_CONNECTION,
...
/*******************************************************************************
  ...
  Description:
    ...
    Multicast groups needed for Conformance are configured.
...
/*******************************************************************************
  ...
  Summary:
    Deconfigures IPv6 addresses once the device leaves the network.

  Description:
    This function deconfigures IPv6 addresses once the device leaves the
    network.
