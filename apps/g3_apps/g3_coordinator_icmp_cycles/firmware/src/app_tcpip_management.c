...
static void _APP_TCPIP_MANAGEMENT_SetIPv6Addresses(TCPIP_NET_HANDLE netHandle)
{
    ...
    TCPIP_IPV6_UnicastAddressAdd(netHandle, &ipv6Address, 0, false);
    ...
    TCPIP_IPV6_UnicastAddressAdd(netHandle,
    ...
    TCPIP_IPV6_G3PLC_PanIdSet(netHandle, panId);
}
    ...
    switch ( app_tcpip_managementData.state )
    {
        ...
        case APP_TCPIP_MANAGEMENT_STATE_WAIT_TCPIP_READY:
        {
            ...
            else if(tcpipStat == SYS_STATUS_READY)
            {
                ...
                TCPIP_NET_HANDLE netHandle = TCPIP_STACK_NetHandleGet("G3ADPMAC");
                _APP_TCPIP_MANAGEMENT_SetIPv6Addresses(netHandle);
