...
#define APP_G3_MANAGEMENT_CONTEXT_INFO_TABLE_0 {0x02, 0x00, 0x01, 0x50, 0xFE, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x1D}

/* Context information  table index 1:
 * Context 1 with value 0x112233445566 (length = 48 bits) */
#define APP_G3_MANAGEMENT_CONTEXT_INFO_TABLE_1 {0x02, 0x00, 0x01, 0x30, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66}
